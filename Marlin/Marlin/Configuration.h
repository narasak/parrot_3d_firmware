 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -24.3, -34.1, -1.80 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 15 // X_CENTER  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 4  // Y_CENTER  // Y point for Z homing
#endif
